    ...
    return (
        ...
        <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'/>
            ...
            <div className='w-1/4 h-screen bg-[#B3B3B3]'>
                ...
                <a href='http://localhost:3001/folder-page/favorite' className='flex w-full h-14 my-4 bg-[#555555] justify-center items-center'>
            ...
            <div className='w-full h-auto'>
                <div className="relative z-10 flex space-x-4 mt-16 ml-20">
                    <div className="flex flex-col ">
                        <div className="relative group box-content w-40 h-48 sm:w-48 sm:h-52 md:w-52 md:h-64 shadow-xl bg-[#B3B3B3] rounded-md transition-transform duration-300 ease-in-out hover:scale-105">
                            <i className='absolute bottom-2 right-2 text-2xl bx bxs-heart opacity-0 group-hover:opacity-100 transition-opacity duration-300'></i>
                        </div>
                    </div>
                </div>
            </div>
