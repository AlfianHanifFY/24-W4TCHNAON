...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-black p-4 shadow-md fixed w-full top-0 z-50 font-ysabeau">
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-white text-2xl font-bold">
          <div className="text-red-600s"><Link href="/" aria-label="Home" onClick={() => handleReload('/')}>
            W4CTHNAON
          </Link></div>
        </div>
        <div className="hidden md:flex flex-grow justify-center space-x-6">
          {navLinks.map((link) => (
            <a
              ...
              className={`text-xl text-gray-300 hover:text-white transition duration-500 ease-in-out ${
