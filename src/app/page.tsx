      ...
      <div className="relative z-10 w-full overflow-hidden">
        <div className="flex w-full">
          ...
          <div className="relative flex w-full">
            <img className="h-auto w-full opacity-10" src="/img/home.png" />
            <div className="absolute mb-24 mr-12 mt-20 w-full">
              <div className="w-full pb-32 pl-28 pr-28 pt-12">
                ...
                <p className="items-center justify-center text-center text-white">
                  ...
                  website is your go-to destination! Discover honest and
                  in-depth reviews from fellow movie enthusiasts, helping you
                  find the perfect film for any mood. Whether you're into
                  action-packed blockbusters, heartwarming dramas, or hidden
                  indie gems, our platform makes it easy to explore, rate, and
                  share your favorite films. Join a community of passionate
                  cinephiles, dive into engaging discussions, and make informed
                  decisions on your next movie night. Start your cinematic
                  adventure with us today and never miss a must-watch movie
                  again!
                </p>
              </div>
              ...
              <div className="relative z-10 mb-20 mt-20 flex h-60 w-full items-center bg-white bg-opacity-20 opacity-100">
                <div className="m-12 h-auto w-4/5">
                  ...
                  <p>
                    ...
                    Quibusdam voluptatem illo iste blanditiis odio? Amet
                    molestias laboriosam quae debitis et sint commodi! Autem
                    doloremque aperiam esse incidunt iure deleniti illum?
                  </p>
                </div>
              ...
              <div className="flex w-full items-center justify-center p-28 text-center">
                <p>
                  ...
                  your personal thoughts, rate films, and explore a wide range
                  of reviews from fellow movie enthusiasts. Whether you’re a
                  casual viewer or a seasoned film critic, our platform allows
                  you to engage with a growing community of cinephiles who love
                  discussing every genre — from blockbuster hits to hidden indie
                  gems. Discover new movies, share your insights, and help
                  others decide what to watch next. With every review, rating,
                  and recommendation, you're contributing to a space where
                  diverse opinions on films are valued and celebrated. Explore
                  the ever-expanding world of cinema and make your voice heard.
